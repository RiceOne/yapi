...
function handleExportRouteParams(url, status, isWiki, catid) {
    ...
    let urlObj = URL.parse(url, true),
        query = {};
    query = Object.assign(query, urlObj.query, {status, isWiki}, {catid});
    return URL.format({
...
class ProjectData extends Component {
    ...
    handleFile = info => {
        ...
        let {importCatid} = this.state;
        if (!importCatid) importCatid = '0';
    ...
    importCatChange = (id, title, item) => {
        this.setState({
            importCatid: id
        });
    }

    exportCatChange = (id, title, item) => {
        this.setState({
            exportCatid: id
        });
    }
                        ...
                        <div className="dataImportCon">
                            ...
                            <div className="catidSelect">
                                <TreeSelect
                                    ...
                                    onChange={this.importCatChange}
                                />
                            </div>
                                {/*        <Select
                  value={this.state.importCatid + ''}
                  showSearch
                  style={{ width: '100%' }}
                    ...
                    <Tooltip title="swagger url 导入">
                      ...
                      &nbsp;&nbsp;
                                        ...
                                        <Dragger {...uploadMess}>
                                            ...
                                            <p
                                                ...
                                                dangerouslySetInnerHTML={{
                                                    __html: importDataModule[this.state.curImportType]
                        ...
                        >
                            ...
                            <div className="dataExport dataSync">
